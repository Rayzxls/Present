...
const SkillTreeSection = () => {
  ...
  return (
    <div className="w-full mb-32 relative text-left">
      <h2 className="text-5xl md:text-6xl font-bold mb-16 text-center text-white [text-shadow:3px_3px_0px_#4a0d0d,_0px_5px_15px_rgba(0,0,0,0.8)] uppercase tracking-tight">ระบบทักษะการเอาชีวิตรอด</h2>
              ...
              {tree.nodes.map((node, i) => {
                ...
                return (
                  <div key={i} className="w-full flex flex-col items-center">
                    {i > 0 && <div className={`w-[3px] h-6 rounded-full ${node.isActive ? 'bg-red-500' : 'bg-red-500/30'}`} />}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6 w-full max-w-[1400px] mx-auto px-4">
        {specialAbilities.map((tree, idx) => (
          <div key={idx} className="bg-gradient-to-b from-black/60 to-red-950/20 p-5 rounded-2xl border border-orange-900/30 backdrop-blur-sm group hover:border-orange-500/50 transition-all flex flex-col items-center">
            <div className="w-16 h-16 rounded-full bg-orange-950/80 border-2 border-orange-500/50 flex items-center justify-center mb-2 text-orange-400 group-hover:scale-110 transition-transform"><tree.icon className="w-8 h-8" /></div>
            <h3 className="text-xl font-bold text-white mb-4 border-b-2 border-orange-500/30 pb-2 w-full text-center tracking-tight">{tree.category}</h3>
            <div className="flex flex-col items-center w-full">
              {tree.nodes.map((node, i) => {
                const Icon = node.icon;
                return (
                  <div key={i} className="w-full flex flex-col items-center">
                    {i > 0 && <div className={`w-[2px] h-4 rounded-full ${node.isActive ? 'bg-orange-500' : 'bg-orange-500/30'}`} />}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative group overflow-hidden rounded-[3rem] border-2 border-orange-900/50 bg-black/40 backdrop-blur-lg mb-12 shadow-2xl">
          <div className="flex flex-col lg:flex-row items-stretch">
            ...
            <div className="w-full lg:w-[55%] p-10 lg:p-16 flex flex-col justify-center">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-8 leading-snug">โมเดลธุรกิจแบบบูรณาการ: อาหาร เครื่องดื่ม และการเสี่ยงโชคครบวงจรในที่เดียว</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="group relative overflow-hidden rounded-[2.5rem] border-2 border-red-900/30 bg-black/40 backdrop-blur-md hover:border-red-500/50 transition-all shadow-xl">
            ...
            <div className="p-8">
              <p className="text-orange-100/70 text-lg leading-relaxed mb-6 font-medium italic border-l-4 border-red-600 pl-6">"เน้นการทำอาหาร และการสร้างพื้นที่ส่วนกลาง สำหรับผู้คนในเมือง ให้มาพบปะพูดคุยและสร้างความสัมพันธ์"</p>
            ...
            <div className="p-8">
              <div className="space-y-6 text-left">
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">Casino จะทำงานได้เมื่อมี <span className="text-white font-bold">ต้นทุนสำรอง</span> เช่น ลงทุน 100,000$ หากเงินทุนหมด ระบบจะหยุดทำงานทันที</p>
                </div>
                <div className="pt-4 border-t border-yellow-900/20 text-left">
                  <h5 className="text-yellow-500 font-bold uppercase text-sm mb-3 tracking-widest text-left">ทางเลือกการเสียภาษี</h5>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-green-900/20 p-4 rounded-2xl border border-green-500/20">
                      <p className="text-green-400 font-bold text-xs uppercase mb-1 text-left">ถูกกฎหมาย</p>
                      <p className="text-white text-sm text-left">จ่าย 15% VAT ให้รัฐบาล (Lawman)</p>
                    </div>
                    <div className="bg-red-900/20 p-4 rounded-2xl border border-red-500/20">
                      <p className="text-red-400 font-bold text-xs uppercase mb-1 text-left">ผิดกฎหมาย</p>
                      <p className="text-white text-sm text-left">ไม่ต้องจ่ายภาษี (ความเสี่ยงสูง)</p>
                    </div>
                  </div>
                </div>
              </div>
  ...
  return (
    <div className="w-full mb-32 text-left">
      <div className="flex flex-col items-center mb-16">
        ...
        <p className="text-orange-400 font-bold tracking-widest uppercase text-center">3 เสาหลักแห่งอำนาจและการปกครอง</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
        <div className="group relative p-10 rounded-[2.5rem] bg-gradient-to-b from-yellow-950/40 to-black/80 border-2 border-yellow-500/30 hover:border-yellow-500 transition-all duration-500 shadow-[0_0_20px_rgba(234,179,8,0.1)]">
          <div className="w-20 h-20 rounded-3xl bg-yellow-500 flex items-center justify-center mb-8 border-4 border-yellow-300/30 text-black shadow-[0_0_20px_rgba(234,179,8,0.4)]"><Crown className="w-10 h-10" /></div>
          <h3 className="text-3xl font-bold text-white mb-6">ประธานณาธิปดี รัฐ</h3>
          <p className="text-orange-100/70 text-lg leading-loose font-medium">การออกกฎหมาย บังคับใช้ในรัฐของตัวเอง การเก็บภาษี รัฐ เพื่อไปพัฒนา รัฐ</p>
          <div className="mt-8 flex items-center gap-2 text-yellow-500 text-sm font-black uppercase"><Landmark className="w-5 h-5" /><span>LEGISLATION & TAXATION</span></div>
        </div>
        <div className="group relative p-10 rounded-[2.5rem] bg-gradient-to-b from-blue-950/40 to-black/80 border-2 border-blue-500/30 hover:border-blue-500 transition-all duration-500 shadow-[0_0_20px_rgba(59,130,246,0.1)]">
          <div className="w-20 h-20 rounded-3xl bg-blue-500 flex items-center justify-center mb-8 border-4 border-blue-300/30 text-white shadow-[0_0_20px_rgba(59,130,246,0.4)]"><Shield className="w-10 h-10" /></div>
          <h3 className="text-3xl font-bold text-white mb-6">Lawman</h3>
          <p className="text-orange-100/70 text-lg leading-loose font-medium">มีหน้าที่ปกป้องรัฐ จากอาชญากรรม โดย Lawman จะขึ้นตรงต่อ รัฐของตัวเองเท่านั้น ไม่จำเป็นต้องรับคำสั่งจากผู้นำรัฐอื่น</p>
          <div className="mt-8 flex items-center gap-2 text-blue-400 text-sm font-black uppercase"><Shield className="w-5 h-5" /><span>LAW ENFORCEMENT</span></div>
        </div>
        <div className="group relative p-10 rounded-[2.5rem] bg-gradient-to-b from-green-950/40 to-black/80 border-2 border-green-500/30 hover:border-green-500 transition-all duration-500 shadow-[0_0_20px_rgba(34,197,94,0.1)]">
          <div className="w-20 h-20 rounded-3xl bg-green-500 flex items-center justify-center mb-8 border-4 border-green-300/30 text-black shadow-[0_0_20px_rgba(34,197,94,0.4)]"><Users className="w-10 h-10" /></div>
          <h3 className="text-3xl font-bold text-white mb-6">ประชาชน</h3>
          <p className="text-orange-100/70 text-lg leading-loose font-medium">ตัวขับเคลื่อน เศรษฐกิจ ของเมือง และ เป็นส่วนหนึ่งของการ พัฒนา และรักษารัฐของตัวเองให้เติบโต</p>
          <div className="mt-8 flex items-center gap-2 text-green-400 text-sm font-black uppercase"><Users className="w-5 h-5" /><span>ECONOMIC DRIVER</span></div>
        </div>
      </div>
    </div>
  );
    ...
    <div className="w-full mb-40 text-left">
      <div className="flex flex-col items-center mb-24">
        <div className="flex items-center gap-6 mb-4">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-white [text-shadow:4px_4px_0px_#4a0d0d] uppercase text-center tracking-tight">Gameplay System</h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-12 lg:gap-20">
          <div className="lg:w-1/3 flex flex-col justify-center items-center lg:items-end relative">
            <motion.div whileHover={{ scale: 1.05 }} className="relative p-1 rounded-[3rem] bg-gradient-to-br from-red-600 to-red-900 shadow-[0_0_50px_rgba(220,38,38,0.3)] z-20">
              <div className="bg-black rounded-[2.9rem] px-10 py-16 border-4 border-red-500/30 flex flex-col items-center text-center max-w-[400px] relative overflow-hidden group">
                <div className="relative mb-6">
                  <motion.div animate={{ filter: ["drop-shadow(0 0 10px #ef4444)", "drop-shadow(0 0 20px #ef4444)", "drop-shadow(0 0 10px #ef4444)"] }} transition={{ repeat: Infinity, duration: 2 }}>
                ...
                <h3 className="text-4xl md:text-5xl font-black text-white uppercase leading-tight mb-6">โซน <span className="text-red-500">Thief Land</span></h3>
                <div className="space-y-4 text-orange-100/70 text-lg font-medium leading-relaxed">
                  <p>(โซน Thief Land) ออกแบบมาทั้งหมด 3 โซน แต่ละโซนจะปล่อยตาม Patch ต่างๆ เพื่อเป็นจุดฟาร์มหาของไปทำอาวุธ</p>
                  <p className="text-red-400 font-bold italic underline decoration-red-500/30 underline-offset-8">"ออกแบบมาให้กลุ่มแก๊งได้แย่งชิงของกัน ในโซนที่มีทรัพยากรจำกัด เพื่ออยู่รอดในโลกที่มีแต่การแข่งขันและแย่งชิง"</p>
                </div>
              </div>
            </motion.div>
          </div>
          <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6 relative">
            {topics.map((topic, i) => (
              <motion.div key={i} initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.1 }} viewport={{ once: true }} className="group relative">
                <div className={`relative overflow-hidden rounded-[2.5rem] bg-black/40 backdrop-blur-md border-2 ${i === 0 ? 'border-red-500 shadow-[0_0_20px_rgba(220,38,38,0.2)]' : 'border-white/5'} group-hover:border-red-500/50 transition-all duration-500 p-8 shadow-xl flex items-start gap-6`}>
                  <div className={`w-16 h-16 shrink-0 rounded-2xl bg-gradient-to-br ${topic.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform`}><topic.icon className="w-8 h-8 text-white" /></div>
                  <div className="relative z-10">
                    <h4 className="text-xl font-black text-white uppercase tracking-wider mb-2 group-hover:text-red-500 transition-colors tracking-tight">{topic.title}</h4>
    ...
    <div className="w-full mb-40 text-left">
      <div className="flex flex-col items-center mb-16 px-4">
        <div className="flex items-center gap-6 mb-6">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-white [text-shadow:4px_4px_0px_#4a3a05] uppercase text-center tracking-tight">World Events</h2>
        </div>
        <div className="w-32 h-2 bg-yellow-500 rounded-full mb-8" />
        <p className="max-w-4xl text-center text-orange-100/60 text-xl font-medium leading-relaxed italic uppercase tracking-wide">
      ...
      <div className="max-w-7xl mx-auto px-4 space-y-12">
        <div className="flex items-center gap-4 mb-8">
          ...
          <span className="text-red-500 font-black uppercase tracking-[0.3em] text-sm flex items-center gap-2 tracking-widest"><Skull className="w-4 h-4" /> Combat & Gameplay Events</span>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <motion.div whileHover={{ y: -10 }} className="relative group overflow-hidden rounded-[3rem] border-2 border-yellow-500/30 bg-gradient-to-br from-yellow-950/20 to-black shadow-2xl p-1">
            <div className="bg-black/80 rounded-[2.9rem] p-10 md:p-12 h-full flex flex-col relative z-10">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 rounded-2xl bg-yellow-500/20 flex items-center justify-center border border-yellow-500/30"><Map className="w-8 h-8 text-yellow-500" /></div>
                <h3 className="text-3xl font-black text-white uppercase tracking-tight">ระบบ Extraction</h3>
              </div>
              <div className="space-y-6 text-orange-100/70 text-lg leading-relaxed font-medium">
                <p><span className="text-yellow-500 font-bold uppercase">New Mode:</span> คือการนำ ปืน ยา เข้าไปใน Map Guama จัดปาร์ตี้สูงสุด 4 คน จัดเป็น 6 ทีม มีเวลาจำกัด 30 นาทีต่อรอบ เพื่อให้ผู้เล่นเข้าไปหาของในนั้น หาของมูลค่าสูงเพื่อไปขาย Economy และหาของ Rare ต่างๆ เพื่อต่อยอดในอาชีพนั้น</p>
                <div className="p-6 rounded-2xl bg-red-500/10 border border-red-500/30 text-red-400 font-bold italic">"ถ้าหากตาย ของที่ฟาร์มได้จะตกและคุณสามารถโดนขโมยของที่ฟาร์มจากพื้นที่ในนั้นได้ และออกมาตัวเปล่า"</div>
              </div>
            </div>
          </motion.div>
          <motion.div whileHover={{ y: -10 }} className="relative group overflow-hidden rounded-[3rem] border-2 border-red-500/30 bg-gradient-to-br from-red-950/20 to-black shadow-2xl p-1">
            <div className="bg-black/80 rounded-[2.9rem] p-10 md:p-12 h-full flex flex-col relative z-10">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 rounded-2xl bg-red-500/20 flex items-center justify-center border border-red-500/30"><ShieldAlert className="w-8 h-8 text-red-500" /></div>
                <h3 className="text-3xl font-black text-white uppercase tracking-tight">ปล้นคลังอาวุธ</h3>
              </div>
              <div className="space-y-6 text-orange-100/70 text-lg leading-relaxed font-medium">
                <p>ออกแบบมาเพื่อให้ผู้เล่นแย่ง กล่องสินค้าอาวุธ สำหรับกล่องที่ได้ไป จะสุ่ม ปืน Tier อาวุธของ Patch นั้นๆ</p>
                <div className="pt-4 border-t border-red-500/20"><div className="flex items-center gap-3 text-red-500 font-black uppercase text-xs tracking-widest animate-pulse"><div className="w-2 h-2 bg-red-500 rounded-full" />Randomized Tier Weapon Rewards</div></div>
              </div>
            </div>
          </motion.div>
        </div>
        <div className="flex items-center gap-4 pt-12 mb-8">
          ...
          <span className="text-blue-500 font-black uppercase tracking-[0.3em] text-sm flex items-center gap-2 tracking-widest"><Users className="w-4 h-4" /> State & Community Events</span>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <motion.div whileHover={{ y: -10 }} className="relative group overflow-hidden rounded-[3rem] border-2 border-blue-500/30 bg-gradient-to-br from-blue-950/20 to-black shadow-2xl p-1">
            <div className="bg-black/80 rounded-[2.9rem] p-10 md:p-12 h-full flex flex-col relative z-10">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 rounded-2xl bg-blue-500/20 flex items-center justify-center border border-blue-500/30"><Star className="w-8 h-8 text-blue-500" /></div>
                <h3 className="text-3xl font-black text-white uppercase tracking-tight">แข่งม้าระหว่าง State</h3>
              </div>
              <p className="text-orange-100/70 text-lg leading-relaxed">การประชันความเร็วและความผูกพันระหว่างผู้เล่นกับพาหนะคู่ใจ ชิงเกียรติยศและรางวัลใหญ่ให้กับรัฐของคุณ</p>
            </div>
          </motion.div>
          <motion.div whileHover={{ y: -10 }} className="relative group overflow-hidden rounded-[3rem] border-2 border-purple-500/30 bg-gradient-to-br from-purple-950/20 to-black shadow-2xl p-1">
            <div className="bg-black/80 rounded-[2.9rem] p-10 md:p-12 h-full flex flex-col relative z-10">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 rounded-2xl bg-purple-500/20 flex items-center justify-center border border-purple-500/30"><Target className="w-8 h-8 text-purple-500" /></div>
                <h3 className="text-3xl font-black text-white uppercase tracking-tight">ศึกมวยตัวแทนรัฐ</h3>
              </div>
              <p className="text-orange-100/70 text-lg leading-relaxed">การต่อสู้ด้วยพละกำลังและชั้นเชิงของตัวแทนในแต่ละรัฐ เพื่อพิสูจน์ว่ารัฐใดคือหนึ่งในด้านความแข็งแกร่ง</p>
            </div>
          </motion.div>
        </div>
      </div>
    ...
    <div className="w-full mb-40 text-left">
      <div className="flex flex-col items-center mb-24">
        <div className="flex items-center gap-6 mb-4">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-white [text-shadow:4px_4px_0px_#1a2e05] uppercase text-center tracking-tight">Economy Ecosystem</h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 relative z-10">
          <div className="flex flex-col items-center gap-8">
            <motion.div whileHover={{ y: -5 }} className="w-full p-6 rounded-[2rem] bg-gradient-to-br from-green-500/20 to-black border-2 border-green-500/30 text-center shadow-xl">
              ...
              <h3 className="text-xl font-black text-white uppercase tracking-tight">ECONOMY กลไกตลาดกลาง</h3>
            </motion.div>
            <ChevronRight className="w-8 h-8 text-green-500/30 rotate-90" />
            <motion.div className="w-full p-8 rounded-[2.5rem] bg-black border-2 border-green-500/50 text-center relative overflow-hidden h-full"><h4 className="text-lg font-black text-white uppercase leading-tight">ทุกอาชีพ มีจุดขายที่เดียวกัน คือจุด Economy กลาง</h4></motion.div>
          </div>
          <div className="flex flex-col items-center gap-8">
            <motion.div whileHover={{ y: -5 }} className="w-full p-6 rounded-[2rem] bg-gradient-to-br from-blue-500/20 to-black border-2 border-blue-500/30 text-center shadow-xl">
              ...
              <h3 className="text-xl font-black text-white uppercase tracking-tight">แบบ ตลาดโลก</h3>
            </motion.div>
            <ChevronRight className="w-8 h-8 text-blue-500/30 rotate-90" />
            <motion.div className="w-full p-8 rounded-[2.5rem] bg-black border-2 border-blue-500/50 text-center relative overflow-hidden h-full"><h4 className="text-lg font-black text-white uppercase leading-tight">ออกแบบมาเพื่อให้ในแต่ละอาชีพ มาวางสินค้าของตัวเองสู่ตลาด PLAYER</h4></motion.div>
          </div>
          <div className="flex flex-col items-center gap-8">
            <motion.div whileHover={{ y: -5 }} className="w-full p-6 rounded-[2rem] bg-gradient-to-br from-orange-500/20 to-black border-2 border-orange-500/30 text-center shadow-xl">
              ...
              <h3 className="text-xl font-black text-white uppercase tracking-tight">แบบ Player to Player</h3>
            </motion.div>
            <ChevronRight className="w-8 h-8 text-orange-500/30 rotate-90" />
            <motion.div className="w-full p-8 rounded-[2.5rem] bg-black border-2 border-orange-500/50 text-center relative overflow-hidden h-full"><h4 className="text-lg font-black text-white uppercase leading-tight">อิสระในการแลกเปลี่ยน สร้าง Story และความสัมพันธ์ในชุมชน</h4></motion.div>
          </div>
        </div>
        ...
        <div className="md:hidden flex flex-col items-center gap-4 py-8"><ChevronRight className="w-8 h-8 text-white/20 rotate-90" /></div>
        <div className="flex flex-col items-center relative">
          <motion.div whileHover={{ scale: 1.02 }} className="w-full max-w-2xl p-1 rounded-[3rem] bg-gradient-to-br from-yellow-400 via-yellow-600 to-yellow-900 shadow-[0_0_70px_rgba(234,179,8,0.2)] z-10">
            <div className="bg-black rounded-[2.9rem] p-10 md:p-12 border-4 border-yellow-500/30 text-center relative overflow-hidden">
              ...
              <h3 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter mb-4 [text-shadow:0_0_20px_rgba(234,179,8,0.5)]">LANDMARK</h3>
              <div className="w-48 h-1 bg-yellow-500/50 mx-auto rounded-full mb-6" />
              <p className="text-orange-100/80 text-xl md:text-2xl font-black max-w-lg mx-auto leading-tight italic uppercase tracking-tight">"เป็นโซนสำหรับ การซื้อขาย, การทำ Community จะมีอยู่จุดเดียวในเซิร์ฟเวอร์"</p>
            </div>
          </motion.div>
          <div className="mt-12 flex gap-12 md:gap-32 relative">
            ...
            <motion.div whileHover={{ y: 5 }} className="flex flex-col items-center gap-4">
              <div className="w-24 h-24 rounded-full bg-slate-500/10 border-4 border-slate-400/30 flex items-center justify-center shadow-lg"><Coins className="w-10 h-10 text-slate-300" /></div>
              <span className="text-2xl font-black text-slate-300 uppercase tracking-widest tracking-tighter">เงิน</span>
            </motion.div>
            <motion.div whileHover={{ y: 5 }} className="flex flex-col items-center gap-4">
              <div className="w-24 h-24 rounded-full bg-yellow-500/10 border-4 border-yellow-500/30 flex items-center justify-center shadow-lg">
                <div className="relative"><Coins className="w-10 h-10 text-yellow-500" /><Zap className="absolute -top-2 -right-2 w-5 h-5 text-yellow-400 animate-pulse" /></div>
              </div>
              <span className="text-2xl font-black text-yellow-500 uppercase tracking-widest tracking-tighter">ทอง</span>
            </motion.div>
          </div>
        </div>
      </div>
    ...
    <div className="w-full mb-40 text-left">
      <div className="flex flex-col items-center mb-16">
        <div className="flex items-center gap-6 mb-4">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-white [text-shadow:4px_4px_0px_#4a3a05] uppercase text-center tracking-tight">ตลาดแลกเปลี่ยนสินค้า</h2>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8">
        <div className="p-12 rounded-[3rem] bg-black/40 backdrop-blur-xl border-2 border-yellow-500/20 flex flex-col justify-center">
          <div className="flex items-center gap-4 mb-8"><div className="w-12 h-1 bg-yellow-500" /><span className="text-yellow-500 font-black uppercase tracking-widest text-sm">Trading Post</span></div>
          <h3 className="text-3xl md:text-4xl font-black text-white mb-6 uppercase leading-tight tracking-tight">จุดสำหรับการแลกเปลี่ยนสิ่งของ<br />ทั้งถูกกฎหมายและผิดกฎหมาย</h3>
          <div className="space-y-6 text-orange-100/60 text-lg leading-relaxed font-medium">
            <p><span className="text-green-500 font-bold uppercase">ในรูปแบบถูกกฎหมาย:</span> ออกแบบมาเพื่อแลกเปลี่ยนสินค้าที่ได้มาจากงานที่ออกแบบมาให้ใช้แลกของ หรือ Event มาเป็นของที่มีมูลค่าสูง</p>
            <p><span className="text-red-500 font-bold uppercase">ในรูปแบบผิดกฎหมาย:</span> ออกแบบมาเพื่อแลกสินค้าจากเงินผิดกฎหมายต่างๆ เช่นการขุดหลุมศพในเขตโซนที่มีการใช้กฎหมายที่อยู่ในเขต RP จะได้เงินผิดกฎหมายมาเพื่อใช้แลกชิ้นส่วนอาวุธปืนหรืออื่นๆ ได้</p>
          </div>
          <div className="flex flex-wrap gap-3 mt-8">
            <div className="px-4 py-2 bg-yellow-500/10 rounded-full border border-yellow-500/30 text-yellow-500 text-xs font-black uppercase tracking-widest">P2P Trading</div>
            <div className="px-4 py-2 bg-yellow-500/10 rounded-full border border-yellow-500/30 text-yellow-500 text-xs font-black uppercase tracking-widest">Global Auction</div>
          </div>
        </div>
        <div className="space-y-6">
          {features.map((f, i) => (
            <div key={i} className="group p-8 rounded-[2rem] bg-gradient-to-r from-yellow-950/20 to-black/60 border border-white/5 hover:border-yellow-500/30 transition-all duration-500 flex items-center gap-6">
              <div className="w-14 h-14 rounded-2xl bg-yellow-500/10 flex items-center justify-center border border-yellow-500/20 group-hover:bg-yellow-500 transition-colors"><f.icon className="w-7 h-7 text-yellow-500 group-hover:text-black transition-colors" /></div>
              <div><h4 className="text-xl font-bold text-white uppercase tracking-wide mb-1 tracking-tight">{f.title}</h4><p className="text-orange-100/40 text-sm">{f.desc}</p></div>
            </div>
          ))}
        </div>
      </div>
...
const LegacyEvolutionSection = () => {
  const evolutions = [
    { old: "ระบบทาส", new: "ต่อยอดสำหรับ การ Upgrade ตัวผู้เล่นให้มีทาส ที่ดีขึ้นจากการ ทำเควส หรือ Mission อะไรบางอย่างของรัฐนั้นๆ", icon: Users, color: "from-green-500 to-green-700" },
    { old: "ระบบเควส", new: "นำระบบเควส ต่อต่อยอดควบคู่กับการฟาม เพื่อ Up Skill Tree", icon: ScrollText, color: "from-yellow-500 to-yellow-700" },
    { old: "ระบบ Raid Camp", new: "นำระบบ Raid Camp ไปต่อยอดใน โซน Thief Land โดยจะให้ เเก๊ง ตั้ง Camp ไว้ใน โซนนั้นเท่านั้น และสามารถนำไป Raid กันได้ ตามเวลาที่กำหนด", icon: ShieldAlert, color: "from-red-500 to-red-700" }
  ];
    ...
    <div className="w-full mb-40 text-left">
      <div className="flex flex-col items-center mb-24 px-4 text-center">
        <div className="flex items-center gap-6 mb-6">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-white [text-shadow:4px_4px_0px_#1e293b] uppercase tracking-tight">ระบบเดิมที่เอาไปใช้ต่อ</h2>
        </div>
        <div className="w-32 h-2 bg-slate-600 rounded-full mb-8" />
        <h3 className="text-3xl font-black text-slate-400 uppercase tracking-widest italic tracking-tight">"การต่อยอดของระบบเดิม"</h3>
      </div>

      <div className="max-w-5xl mx-auto px-4 relative">
        <div className="grid grid-cols-2 mb-12 px-8">
          <div className="text-xl font-black text-slate-500 uppercase tracking-[0.3em] text-center tracking-widest">ระบบเดิม</div>
          <div className="text-xl font-black text-white uppercase tracking-[0.3em] text-center tracking-widest">ต่อยอดกับอะไร</div>
        </div>

        <div className="space-y-12 relative">
          {evolutions.map((item, i) => (
            <div key={i} className="grid grid-cols-2 gap-8 lg:gap-20 items-center relative group">
              <motion.div whileHover={{ x: -10 }} className="p-8 rounded-[2.5rem] bg-black border-2 border-slate-800 text-right shadow-xl">
                <h4 className="text-xl font-bold text-slate-500 uppercase tracking-wide tracking-tight">{item.old}</h4>
              </motion.div>

              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center z-20">
                <div className="relative">
                  <div className="w-16 h-16 rounded-2xl bg-slate-900 border-2 border-white/10 flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform">
                    <item.icon className="w-8 h-8 text-white" />
                  </div>
                  <div className="absolute top-1/2 left-[100%] ml-2 -translate-y-1/2 flex items-center">
              ...
              <motion.div whileHover={{ x: 10 }} className={`p-8 rounded-[2.5rem] bg-gradient-to-r ${item.color} text-left shadow-[0_0_40px_rgba(255,255,255,0.05)]`}>
                <h4 className="text-xl font-black text-white uppercase tracking-wider tracking-tight">{item.new}</h4>
              </motion.div>
            </div>
          ))}
          <div className="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-0.5 bg-gradient-to-b from-transparent via-slate-700/30 to-transparent pointer-events-none" />
        </div>

        <div className="mt-24 p-10 rounded-[3rem] bg-slate-900/30 border border-slate-800 text-center">
          <p className="text-slate-400 text-lg leading-relaxed font-medium italic tracking-tight">
            "การต่อยอดไม่ได้หมายถึงการเปลี่ยนโฉมใหม่ทั้งหมด แต่เป็นการมอบความหมายใหม่ให้กับระบบที่คุณคุ้นเคย เพื่อความยั่งยืนของรัฐ Texas RP"
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-[#1a0505] text-white flex flex-col items-center p-8 relative overflow-x-hidden font-kanit">
      ...
      >
        <header className="mb-16 text-center">
          ...
          <motion.h1 className="text-6xl md:text-[5.5rem] font-bold mb-8 text-[#ffdac4] uppercase tracking-wide [text-shadow:4px_4px_0px_#4a0d0d,_0px_10px_20px_rgba(0,0,0,0.8)]">
            แนวทางของเซิฟเวอร์
          </motion.h1>

          <motion.p className="text-xl md:text-[1.4rem] text-orange-50/90 font-medium max-w-4xl mx-auto leading-loose [text-shadow:1px_1px_5px_rgba(0,0,0,1)]">
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-12 mb-32 text-left">
          <div className="group relative p-8 rounded-3xl bg-gradient-to-b from-red-950/40 to-black/60 border border-red-900/50 hover:border-red-500/50 transition-all duration-500 overflow-hidden backdrop-blur-sm shadow-xl">
            <div className="relative z-10">
          ...
          <div className="group relative p-8 rounded-3xl bg-gradient-to-b from-orange-950/40 to-black/60 border border-orange-900/50 hover:border-orange-500/50 transition-all duration-500 overflow-hidden backdrop-blur-sm shadow-xl">
            <div className="relative z-10">
        ...
        <div className="w-full mb-32">
          <h2 className="text-5xl md:text-6xl font-bold mb-12 text-center text-white tracking-wide [text-shadow:3px_3px_0px_#4a0d0d,_0px_5px_10px_rgba(0,0,0,0.8)] uppercase">
            ...
            {races.map((race, index) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <div className={`absolute inset-0 transition-all duration-500 ${isActive ? 'bg-gradient-to-t from-black/95 via-black/30 to-transparent' : 'bg-gradient-to-t from-black/80 via-black/50 to-black/30'}`} />
                  {isActive ? (
                    <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8 text-left">
                      <motion.h3 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-4xl md:text-5xl font-black text-white mb-4 [text-shadow:2px_2px_8px_rgba(0,0,0,0.9)]">{race.name}</motion.h3>
                      <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="flex items-stretch w-fit">
                        <div className="w-14 bg-red-700 flex items-center justify-center shrink-0 rounded-l-lg px-4 py-3"><span className="text-2xl md:text-3xl font-black text-white">{race.id}</span></div>
