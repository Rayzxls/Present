...
const LegacyEvolutionSection = () => {
  const evolutions = [
    { old: "ระบบเก็บของป่า / ตกปลา", new: "ระบบอาชีพ & Skill Tree", icon: Axe, color: "from-green-500 to-green-700" },
    { old: "ระบบการเงินพื้นฐาน", new: "ECONOMY กลาง & Landmark", icon: Coins, color: "from-yellow-500 to-yellow-700" },
    { old: "ระบบต่อสู้ / การปะทะ", new: "Extraction Mode & World Events", icon: Skull, color: "from-red-500 to-red-700" }
  ];
